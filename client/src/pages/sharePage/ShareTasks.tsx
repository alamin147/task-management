...
import { useGetSharedTasksQuery } from "../../redux/features/tasks/tasksApi";
import TaskItem from "../../components/taskItem/TaskItem";
import { TTask } from "../../types/types";
import { Select, Tooltip } from "antd";
import { useEffect, useState } from "react";
const ShareTasks = () => {
  const { data, isLoading } = useGetSharedTasksQuery(undefined);
        ...
        <main className="m-6 h-full">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6">
            <h1 className="text-2xl font-bold text-custom-green-dark mb-4 sm:mb-0">
              <span className="border-b-4 border-custom-green pb-1">Shared Tasks</span>
            </h1>
